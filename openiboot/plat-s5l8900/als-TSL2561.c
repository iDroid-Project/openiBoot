...
static int cmd_als(int argc, char** argv)
{
	bufferPrintf("data = %d\r\n", als_data());
...
static int cmd_als_channel(int argc, char** argv)
{
	if(argc < 2)
	{
...
static int cmd_als_en(int argc, char** argv)
{
...
static int cmd_als_dis(int argc, char** argv)
{
