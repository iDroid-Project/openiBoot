...
static const I2CInfo I2CInit[] = {
			{0, 0, 0, 0, 0, I2CDone, 0, 0, 0, 0x400, 0x401, 0x13, I2C0 + IICREG0, I2C0 + IICREG8, I2C0 + IICREGC, I2C0 + IICREG10, I2C0 + IICREG14, I2C0 + IICREG18, I2C0 + IICREG20, I2C0 + IICREG24, 0x39},
			{0, 0, 0, 0, 0, I2CDone, 0, 0, 0, 0x402, 0x403, 0x12, I2C1 + IICREG0, I2C1 + IICREG8, I2C1 + IICREGC, I2C1 + IICREG10, I2C1 + IICREG14, I2C1 + IICREG18, I2C1 + IICREG20, I2C1 + IICREG24, 0x3A},
			{0, 0, 0, 0, 0, I2CDone, 0, 0, 0, 0x404, 0x405, 0x11, I2C2 + IICREG0, I2C2 + IICREG8, I2C2 + IICREGC, I2C2 + IICREG10, I2C2 + IICREG14, I2C2 + IICREG18, I2C2 + IICREG20, I2C2 + IICREG24, 0x3B},
		};
