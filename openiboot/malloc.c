...
static int cmd_malloc_stats(int argc, char** argv)
{
	malloc_stats();
...
#define ABORT while(0) { bufferPrintf("malloc error\r\n"); while(1); } //udelay(uSecPerSec); }
...
void* sbrk(intptr_t incr) {
	...
	CurBreakValue = (void*)(((uint8_t*)CurBreakValue) + incr);
