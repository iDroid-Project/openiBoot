...
static int cmd_images_list(int argc, char** argv)
{
	images_list();
...
static int cmd_images_read(int argc, char** argv)
{
	if(argc < 3) {
...
static int cmd_images_install(int argc, char** argv)
{
	if(argc < 4) {
...
static int cmd_images_uninstall(int argc, char** argv)
{
	if(argc < 4) {
